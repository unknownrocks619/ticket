...
<nav class="navbar">
    ...
    <div class="navbar-content">
        <form class="search-form" method="get" action="{{ route('admin.ticket.search') }}">
            <div class="input-group">
                <div class="input-group-text">
                    <i data-feather="search"></i>
                </div>
                <input type="text" name="serial_number" class="form-control" id="navbarForm" placeholder="Type Your Ticket Number Here to search">
            </div>
        </form>
        <ul class="navbar-nav">
