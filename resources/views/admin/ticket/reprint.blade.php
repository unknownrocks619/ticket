...
<div class="container-fluid  mb-11 mx-auto px-0">
    <div class="row px-0 mx-auto">
        ...
        <div class="col-md-12 pl-0 ml-0 mx-auto step-parent pb-5">
            ...
            // } 
            ?>
            <iframe id="print_area" @if(settings('print_paper')=='ticket-paper' ) class="w-25" style="overflow:hidden;height:15.3cm;width:8.3cm" @else class="w-100" style="height:500px;" @endif src="{{ route('admin.ticket.print',$ticket->uuid) }}" title="print-ticket" </iframe>
                <!-- / Form -->
        </div>
